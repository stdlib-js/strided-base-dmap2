...
```javascript
import dmap2 from 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dmap2@v0.2.3-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/strided-base-dmap2/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/strided-base-dmap2/actions/workflows/test.yml?query=branch:v0.2.3
